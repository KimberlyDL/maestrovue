...
<template>
    <div class="max-w-7xl px-4 sm:px-6 py-6 lg:px-8">
        <div class="h-full flex flex-col gap-8">
            ...
            <div
                class="relative p-4 bg-white dark:bg-abyss-800 rounded-xl border border-gray-200 dark:border-abyss-700 shadow-lg">
            ...
            <div class="flex-1 overflow-y-auto space-y-4">
                ...
                <div v-else-if="filteredSwaps.length === 0"
                    ...
                    <p class="text-sm text-gray-500 dark:text-platinum-500 mt-2">Check back later for duty swap
                        opportunities</p>
                </div>
