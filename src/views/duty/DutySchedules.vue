...
<template>
    <div class="h-full flex flex-col gap-8">
        ...
        <div class="flex-1 overflow-y-auto">
            ...
            <div v-else-if="filteredSchedules.length === 0" class="text-center py-12 bg-white dark:bg-abyss-800 rounded-xl border border-gray-200 dark:border-abyss-700 shadow-lg">
            ...
            <div v-else class="grid gap-4">
                <div v-for="schedule in filteredSchedules" :key="schedule.id" @click="openDetailModal(schedule)"
                    ...
                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-abyss-700 rounded-xl border border-gray-200 dark:border-abyss-600 shadow-inner">
